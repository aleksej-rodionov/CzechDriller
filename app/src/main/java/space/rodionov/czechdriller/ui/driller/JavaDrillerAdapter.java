...
//        this.nativeLanguage = nativeLanguage;
    ...
    @NonNull
    @Override
    public JavaDrillerViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.cardstack_item, parent, false);
        JavaDrillerViewHolder javaDrillerViewHolder = new JavaDrillerViewHolder(view);
        return javaDrillerViewHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull JavaDrillerViewHolder holder, int position) {
