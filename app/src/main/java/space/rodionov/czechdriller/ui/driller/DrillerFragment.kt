...
import space.rodionov.czechdriller.databinding.CardstackLayoutBinding
import space.rodionov.czechdriller.ui.driller.DrillerAdapterJava
...
class DrillerFragment : Fragment(R.layout.cardstack_layout), CardStackListener {
    ...
    private lateinit var drillerAdapter: DrillerAdapterJava/*? = null*/

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)

        val binding = CardstackLayoutBinding.bind(view)
        drillerAdapter = DrillerAdapterJava(DrillerAdapterJava.DrillerDiff(), false, requireContext())
